 ...
 */
package org.kuali.coeus.common.protocol.impl.protocol.funding.impl;
...
public abstract class ProposalDevelopmentProtocolDocumentServiceImplBase<T extends ProtocolDocumentBase>  {
    ...
    throws Exception
    {
        ...
        org.kuali.coeus.common.protocol.impl.actions.ProtocolActionBase protocolAction = getProtocolActionNewInstanceHook(protocolDocument.getProtocol(), null, getProtocolActionProtocolCreatedCodeHook());      
