 ...
 */
package org.kuali.coeus.common.protocol.impl.actions.copy;
...
import org.kuali.coeus.common.protocol.impl.noteattachment.ProtocolNotepadBase;
...
public abstract class ProtocolCopyServiceImplBase<GenericProtocolDocument extends ProtocolDocumentBase> implements ProtocolCopyService<GenericProtocolDocument> {
    ...
    /**
     * @see org.kuali.coeus.common.protocol.impl.actions.copy.ProtocolCopyService#copyProtocol(org.kuali.coeus.common.protocol.impl.ProtocolDocumentBase)
     */
    ...
    /**
     * @see org.kuali.coeus.common.protocol.impl.actions.copy.ProtocolCopyService#copyProtocol(org.kuali.coeus.common.protocol.impl.ProtocolDocumentBase, java.lang.String)
     */
    ...
    protected GenericProtocolDocument createNewProtocol(GenericProtocolDocument srcDoc, String protocolNumber, boolean isAmendmentRenewal) throws Exception {
        ...
        org.kuali.coeus.common.protocol.impl.actions.ProtocolActionBase protocolAction = getProtocolActionNewInstanceHook(newDoc.getProtocol(), null, getProtocolActionProtocolCreatedCodeHook());
    ...
    protected abstract Class<? extends org.kuali.coeus.common.protocol.impl.actions.ProtocolActionBase> getProtocolActionBOClassHook();
