...
public class CommitteeScheduleAction extends CommitteeScheduleActionBase {
    ...
    protected DeleteCommitteeScheduleEventBase getNewDeleteCommitteeScheduleEventInstanceHook(String errorPathPrefix,
            Document document, ScheduleData scheduleData, List<CommitteeScheduleBase> committeeSchedules, org.kuali.coeus.common.protocol.impl.committee.schedule.event.CommitteeScheduleEventBase.ErrorType type) {
