...
import org.kuali.coeus.common.protocol.impl.committee.membership.CommitteeMembershipActionBase;
import org.kuali.coeus.common.protocol.impl.committee.membership.CommitteeMembershipBase;
import org.kuali.coeus.common.protocol.impl.committee.membership.CommitteeMembershipServiceBase;
...
public class CommitteeMembershipAction extends CommitteeMembershipActionBase {
    ...
    protected DeleteCommitteeMemberEventBase getNewDeleteCommitteeMemberEventInstanceHook(String errorPathPrefix,
            Document document, List<CommitteeMembershipBase> committeeMemberships, org.kuali.coeus.common.protocol.impl.committee.member.event.CommitteeMemberEventBase.ErrorType type) {
