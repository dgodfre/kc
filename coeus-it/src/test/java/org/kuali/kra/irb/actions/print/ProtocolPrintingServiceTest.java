...
public class ProtocolPrintingServiceTest extends PrintingServiceTestBase {
    ...
    public void testGetProtocolPrintable() {
        ...
        Printable printable = getPrintingService().getProtocolPrintable(org.kuali.coeus.common.protocol.impl.actions.print.ProtocolPrintType.PROTOCOL_FULL_PROTOCOL_REPORT);
        assertTrue(printable instanceof ProtocolFullProtocolPrint);
        printable = getPrintingService().getProtocolPrintable(org.kuali.coeus.common.protocol.impl.actions.print.ProtocolPrintType.PROTOCOL_PROTOCOL_HISTORY_REPORT);
        assertTrue(printable instanceof ProtocolHistoryPrint);
        printable = getPrintingService().getProtocolPrintable(org.kuali.coeus.common.protocol.impl.actions.print.ProtocolPrintType.PROTOCOL_REVIEW_COMMENTS_REPORT);
        assertTrue(printable instanceof ProtocolReviewCommentsPrint);
        printable = getPrintingService().getProtocolPrintable(org.kuali.coeus.common.protocol.impl.actions.print.ProtocolPrintType.PROTOCOL_SUMMARY_VIEW_REPORT);
