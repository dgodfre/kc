...
public class CommitteeMembershipAddRuleTest extends CommitteeRuleTestBase {
    private org.kuali.coeus.common.protocol.impl.committee.membership.rule.CommitteeMembershipRule rule;
    
    @Before
    public void setup() throws Exception {
        super.setUp();
        rule = new org.kuali.coeus.common.protocol.impl.committee.membership.rule.CommitteeMembershipRule();
    }
